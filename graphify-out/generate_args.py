...
for idx, chunk in enumerate(chunks):
    ...
    subagents_config.append({
        "TypeName": "self",
        "Role": f"Graphify Chunk {chunk_num:02d}",
        "Prompt": prompt,
        "Workspace": "inherit"
    })

Path("graphify-out/.graphify_subagents_args.json").write_text(json.dumps(subagents_config, indent=2), encoding="utf-8")
print(f"Generated configurations for {total_chunks} subagents.")
